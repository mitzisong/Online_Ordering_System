...
class SignupForm(Form):
    ...
    month = SelectField("What month would you like your cupcakes?", choices=[("jan", "January"), ("feb", "February"), ("mar", "March"),  ("apr", "April"), ("may", "May"), ("jun", "June"), ("jul", "July"), ("aug", "August"), ("sept", "September"), ("oct", "October"), ("nov", "November"), ("dec", "December")])
...
class ChooseDecorationsForm(Form):
    decoration = SelectField("What decoration theme would you like?", choices=[("sig", "Signature"), ("fest", "Festive"), ("birth", "Birthday"), ("baby", "Baby Shower"), ("bridal", "Bridal Shower"), ("anim", "Animals"), ("under", "Under the Sea"), ("sports", "Sports"), ("49ers", "49ers"), ("sf", "SF Giants"), ("ny", "New Years"), ("val", "Valentine's Day"), ("patrick", "St. Patrick's Day"), ("easter", "Easter"), ("4th", "4th of July"), ("halloween", "Halloween"), ("thanks", "Thanksgiving"), ("xmas", "Christmas")])
    color1 = SelectField("What color scheme would you like?", choices=[("red", "Red"), ("orange", "Orange"), ("pasorange", "Pastel Orange"), ("yellow", "Yellow"), ("pasyellow", "Pastel Yellow"), ("green", "Green"), ("pasgreen", "Pastel Green"), ("turquoise", "Turquoise"), ("pasturquoise", "Pastel Turquoise"), ("blue", "Blue"), ("pasblue", "Pastel Blue"), ("purple", "Purple"), ("lavender", "Lavender"), ("brown", "Brown"), ("grey", "Grey"), ("black", "Black")])
    color2 = SelectField("What color scheme would you like?", choices=[("red", "Red"), ("orange", "Orange"), ("pasorange", "Pastel Orange"), ("yellow", "Yellow"), ("pasyellow", "Pastel Yellow"), ("green", "Green"), ("pasgreen", "Pastel Green"), ("turquoise", "Turquoise"), ("pasturquoise", "Pastel Turquoise"), ("blue", "Blue"), ("pasblue", "Pastel Blue"), ("purple", "Purple"), ("lavender", "Lavender"), ("brown", "Brown"), ("grey", "Grey"), ("black", "Black")])
    color3 = SelectField("What color scheme would you like?", choices=[("red", "Red"), ("orange", "Orange"), ("pasorange", "Pastel Orange"), ("yellow", "Yellow"), ("pasyellow", "Pastel Yellow"), ("green", "Green"), ("pasgreen", "Pastel Green"), ("turquoise", "Turquoise"), ("pasturquoise", "Pastel Turquoise"), ("blue", "Blue"), ("pasblue", "Pastel Blue"), ("purple", "Purple"), ("lavender", "Lavender"), ("brown", "Brown"), ("grey", "Grey"), ("black", "Black")])
    submit = SubmitField("Continue")